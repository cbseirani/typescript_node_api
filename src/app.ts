...
import { getWeatherByCoordinates, getWeatherByCityState, getCoordinatesByCityState } from './controllers/weatherController';
...
app.get('/weather/city-state', getWeatherByCityState);
app.get('/weather/coordinates', getCoordinatesByCityState);
